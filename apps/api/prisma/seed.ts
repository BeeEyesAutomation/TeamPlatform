...
const permissions = [
  ...
  "quotation_templates.layout_edit",
  "quotation_templates.version_manage",
...
async function seedRolesAndPermissions() {
  ...
  const quotationRolePermissions: Record<string, string[]> = {
    ...
    accountant: ["quotations.view", "quotations.manage", "quotations.preview", "quotations.export", "quotations.version.view", "quotations.version.create", "quotation_templates.view", "quotation_templates.manage", "quotation_templates.layout_edit", "quotation_templates.version_manage", "quotation_settings.manage"],
    project_manager: ["quotations.view", "quotations.manage", "quotations.preview", "quotations.export", "quotations.delete", "quotations.approve", "quotations.version.view", "quotations.version.create", "quotations.stock_out", "quotations.customer_po.upload", "quotation_templates.view", "quotation_templates.layout_edit"],
